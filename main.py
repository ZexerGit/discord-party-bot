...
# คำสั่ง help อธิบายการใช้งานทั้งหมด
@bot.command()
async def help(ctx):
    help_text = (
        ...
        "**!help** → แสดงข้อความช่วยเหลือวิธีใช้งานนี้\n\n"
